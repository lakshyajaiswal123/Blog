          ...
          <React.Fragment key={index}>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div>
                ...
                {/* Main-Heading */}
                <h1
                  className=" w-full lg:max-w-[535px] font-DM-Sans
                             text-[#0D0F12] font-bold md:font-semibold
                             text-[25px] sm:text-3xl lg:text-[40px]
                             leading-tight md:leading-10.5
                             tracking-wide"
                >
                  {item.heading}
                </h1>
                ...
                {/* Sub Heading */}
                <p
                  className=" w-full lg:max-w-[490px] mt-2 lg:mt-4 text-sm md:text-xl
                             font-normal tracking-wide font-DM-Sans
                             leading-tight md:leading-6.5"
                >
                  {item.subHeading}
                </p>
              </div>
              ...
              {/* Tags */}
              <div className="flex flex-wrap gap-2 sm:gap-3 mt-5 xl:mt-auto">
                {item.tags.map((tag, i) => (
                  <span
                    key={i}
                    className="bg-[#D9D9D9] text-[#0D0F12]
                               font-DM-Sans
                               px-3 py-1
                               text-xs sm:text-sm
                               whitespace-nowrap
            ...
            <div className="flex-1 flex items-center justify-center md:p-0 pb-5">
              <img
                src={Banner}
                alt="Hero Banner"
                className="w-full lg:max-w-[598px] h-auto object-cover"
              />
            </div>
          </React.Fragment>
        ))}
